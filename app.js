...
// 5. CONTROLLI BASE (Aggiornato con la funzione Flip)
$('#startBtn').on('click', board.start);
$('#clearBtn').on('click', board.clear);
$('#flipBtn').on('click', board.flip); // <-- NUOVA RIGA: Capovolge la scacchiera ad ogni click!

$('#getFenBtn').on('click', function() {
    // Ridotto il testo del bottone in HTML in "FEN" per salvare spazio su smartphone
    $('#currentFenDisplay').text(board.fen());
});
